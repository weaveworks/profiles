...
// the ProfileSubscription object against the actual cluster state, and then
...
func (r *ProfileSubscriptionReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("profilesubscription", req.NamespacedName)
...
func (r *ProfileSubscriptionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&weaveworksv1alpha1.ProfileSubscription{}).
		Complete(r)
}
